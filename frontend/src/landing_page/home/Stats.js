        ...
        <div className="container p-3">
            <div className="row p-5">
                <div className="col-6 p-5">
                    ...
                    <p className="text-muted">With initiatives like Nudge and Kill Switch,we dont trsut facilitate transactions,but actively help you do better with your money.</p>

                </div>
                <div className="col-6 p-5">
                    <img src="media/images/11_ecosystem.png" style={{width:"90%"}}/>
