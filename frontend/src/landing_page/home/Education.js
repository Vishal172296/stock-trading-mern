        ...
        <div className="container mt-5">
            ...
            <div className="col-6">
                ...
                <div className="col-6">
                    ...
                    <p>Varsity, the online stock market education book in the world covering everything from the basics to advanced trading.</p>
                    <a href="" style={{textDecoration:"none"}}>Versity<i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                    <p className="mt-5">TradingQ&A,the most active trading and ivestment community in India for all your market related queries.</p>
